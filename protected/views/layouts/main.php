...
$assetsUrl = Yii::app()->request->baseUrl;

$assetsManager = Yii::app()->clientScript;
$assetsManager->registerCoreScript('jquery');

$assetsManager->registerScriptFile($assetsUrl.'/js/main.js');
?>
	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
                ...
                array('label'=>'Календарь заявок', 'url'=>array('/orders/calend'), 'visible'=>Yii::app()->getModule('user')->isAdmin()),
